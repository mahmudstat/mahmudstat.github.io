...
\begin{document}
\makeheading [\includegraphics{mahmud}]
{Abdullah Al Mahmud}
...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
	...
	& \href{https://www.thinkermahmud.com/}{Website}/\href{https://github.com/mahmudstat}{Github}/\href{https://www.linkedin.com/in/mahmudstat/t}{LinkedIn}\\
\end{tabular}
...
\textbf{Science Contributor} \hfill{October 2016 - August 2019}
	\begin{innerlist}
		\item[]{\href{https://www.bigganchinta.com}{Bigganchinta, The Daily Prothom Alo}/ Dhaka/ Bangladesh}
	\end{innerlist}
...
\section{Books}
\href{https://www.rokomari.com/book/128479/a-briefer-history-of-time} {Translation of \textbf{A Briefer History of Time}} \hfill{2017 Ekushey Book Fair}
	\begin{innerlist}
		\item[]{ Authored by Stephen Hawking and Leonard Mlodino}
	\end{innerlist}
\flushleft
\href{https://www.rokomari.com/book/177345/mohabiswer-simana}{\textbf{Mohabishwer Simana (Edge of the Universe)}} \hfill{2019 Ekushey Book Fair}
%	\begin{innerlist}
%		\item[]{To be published}
%	\end{innerlist}

\flushleft
\href{https://www.rokomari.com/book/179175/osim-somikoron}{\textbf{Osim Somikoron (The Infinite Equation)}} \hfill{2019 Ekushey Book Fair}
%	\begin{innerlist}
%		\item[]{To be published}
%	\end{innerlist}

\flushleft
\href{https://www.rokomari.com/book/214940/the-last-three-minutes}{Trnslation of \textbf{The Last Three Minutes}} \hfill{2021 Ekushey Book Fair}
	\begin{innerlist}
		\item[]{Authored by Paul Davies}
	\end{innerlist}
...
\begin{innerlist}
	...
	\item[] Statistical Packages: \hfill {STATA, SPSS, TABLEAU, EXCEL} \\
	...
	\item[] Internet Skills: \hfill {MathJax, HTML, CSS, SVG, JS, Google Data Studio} \\
\end{innerlist}
...
\section{Journal}
\begin{innerlist}
	\item Mahmud, A, A . 2018. {Testing of Compliance of Benford’s Law with Disaster Death Tolls.} Cadet College Journal. 
\end{innerlist}
...
\href{https://www.statmania.info} {\textbf StatMania.info}  \hfill{November 2016}
	...
	\end{innerlist}
\flushleft
\href{https://www.thinkermahmud.com/} {\textbf Portfolio website}  \hfill{March 2018}
	\begin{innerlist}
		\item[] {Personal Website.}
	\end{innerlist}
\flushleft
\href{https://lecture.statmania.info} {\textbf Statistics Lectures}  \hfill{December 2020}
	\begin{innerlist}
		\item[] {Academic lectures and resources on statistics and mathematics}
	\end{innerlist}
\flushleft
...
\begin{innerlist}
	\item Former Member at Dhaka University Science Society (DUSS), University of Dhaka.
