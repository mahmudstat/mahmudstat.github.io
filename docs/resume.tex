...
I am a \textbf{lecturer in statistics} at \emph{Sylhet Cadet College}, Sylhet. Earlier I taught statistics at \emph{Pabna Cadet College}. Before joining Cadet College service, I was employed as a research assistant at \emph{EAL}, Dhaka. I also worked as a science contributor for \emph{The Daily Prothom Alo}.
...
{\centering \includegraphics[width=0.6\linewidth]{img/books/briefer_history_of_time} 
...
{\centering \includegraphics[width=0.6\linewidth]{img/books/ms} 
...
{\centering \includegraphics[width=0.6\linewidth]{img/books/cover_os} 
...
{\centering \includegraphics[width=0.6\linewidth]{books/images/books/l3m} 
...
\hypertarget{random-tours}{%
\section*{Random Moments}\label{random-tours}}
\addcontentsline{toc}{section}{Random Moments}

\begin{figure}

{\centering \includegraphics[width=0.6\linewidth]{img/miu1} 
...
{\centering \includegraphics[width=0.6\linewidth]{img/sangla} 
...
{\centering \includegraphics[width=0.6\linewidth]{img/lalmai} 
...
{\centering \includegraphics[width=0.6\linewidth]{img/cholonbil} 
...
{\centering \includegraphics[width=0.6\linewidth]{img/pabna_mill} 
...
{\centering \includegraphics[width=0.6\linewidth]{images/qr_mahmud} 

}

\caption{Contact Details}\label{fig:unnamed-chunk-1}
\end{figure}
